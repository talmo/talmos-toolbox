...
defmain.verbosity = 0;
defmain.saveAnimation = 0; % Save the mesh deformation frames as an animation
...
if ~isfield(main,'verbosity') || isempty(main.verbosity), main.verbosity = defmain.verbosity; end;
